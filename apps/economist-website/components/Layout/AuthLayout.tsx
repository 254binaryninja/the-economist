      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center p-8 lg:p-12">
          ...
          >
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-white dark:text-white mb-2">
              The Economist AI
            </h1>
            <p className="text-white/90 dark:text-white/90 text-lg">
              Expert Economic Analysis & Insights
            </p>
          </motion.div>
