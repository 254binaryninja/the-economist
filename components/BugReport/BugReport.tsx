...
export default function BugReport() {
  ...
  const handleBugReport = async () => {
    try {
      ...
      if (
        !bugReport.userName ||
        !bugReport.briefDescription ||
        !bugReport.completeDescription
      ) {
  ...
  return (
    <DialogContent className="sm:max-w-[425px]">
      <div className="grid gap-4 py-4">
        ...
        <div className="grid gap-2">
          ...
          <Input
            ...
            onChange={(e) =>
              setBugReport({ ...bugReport, briefDescription: e.target.value })
            }
      ...
      <div className="flex justify-end gap-2">
        ...
        <Button onClick={handleBugReport} disabled={isSubmitting}>
