            ...
            <div className="max-w-md w-full p-0">
                <div className="relative p-2">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="text-sm text-gray-500">Edit your platform theme.</div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="text-xs text-gray-400 mt-1">More languages are coming soon.</div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="mb-3">
                            <div className="flex justify-between text-sm">
                                <span>Verbosity</span>
                                <span>Less Creative&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; More Creative</span>
                            </div>                            <Slider
                                min={0.0}
                                max={1.0}
                                step={0.01}
                                ...
                                onValueChange={(values) => {
                                    if (typeof values[0] === "number") setVerbosityState(values[0]);
                                }}
                        ...
                        <div className="mb-3">
                            <div className="flex justify-between text-sm">
                                <span>Style</span>
                                <span>Bullet Points &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Paragraphs</span>
                            </div>
                            <Slider
                                min={0}
                                max={100}
