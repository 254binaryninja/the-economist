        ...
        <Sidebar className="transition-all duration-300 ease-in-out">
            ...
            <SidebarContent>
                <SidebarGroup>
                    ...
                    <div className="mt-8 border-t pt-4">
                        <SidebarGroupLabel className="text-sm font-medium text-gray-500 dark:text-gray-400 px-4">Support & Settings</SidebarGroupLabel>
                        <SidebarGroupContent>
                            <SidebarMenu>
                                <SidebarMenuItem>
                                    <Dialog>
            ...
            <SidebarFooter className="p-4 border-t">
                <div className="flex flex-col items-center">
                    {mounted && <UserButton />}
                    <span className="mt-2 text-xs text-gray-500 dark:text-gray-400 text-center">Manage your account and profile info here</span>
                </div>
            </SidebarFooter>
        </Sidebar>
    )
