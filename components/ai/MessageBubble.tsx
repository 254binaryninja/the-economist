...
import { User, Bot , Clipboard, Check, ThumbsUp,ThumbsDown } from 'lucide-react';
...
export function MessageBubble({ message, isLast, onToggleUpvote }: MessageBubbleProps) {  const isAssistant = message.role === 'assistant';
    ...
    <div className={cn(
      ...
      <Avatar className="h-6 w-6 sm:h-8 sm:w-8 shrink-0 mt-1">
        <AvatarFallback className={cn(
          ...
          {isAssistant ? <Image src="/images/logo.png" alt="Economist" width={24} height={24} className="sm:w-8 sm:h-8" /> : <User className="h-3 w-3 sm:h-4 sm:w-4" />}
        </AvatarFallback>
      </Avatar>
        ...
        {isAssistant ? (
          <div className="max-w-[95%] sm:max-w-[85%] p-3 sm:p-4 space-y-2 sm:space-y-3 relative">
            ...
            {message.experimental_attachments && message.experimental_attachments.length > 0 && (
              <MessageAttachments attachments={message.experimental_attachments} />
            )}
            ...
            <div className="flex items-center justify-between mt-2 sm:mt-3">
              ...
              <div className='flex items-center gap-0.5 sm:gap-1'>
                <button
                  ...
                  title={message.isUpvoted === true ? "Remove upvote" : "Upvote this response"}
                >
                ...
                <button
                  ...
                  title={message.isUpvoted === false ? "Remove downvote" : "Downvote this response"}
                >
