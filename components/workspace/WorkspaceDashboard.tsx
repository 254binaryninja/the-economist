  ...
  return (
    <div className="p-3 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-4 sm:space-y-6">
        <div className="max-w-2xl px-4">
          ...
          <p className="text-sm sm:text-base text-muted-foreground mt-2">
            Manage your economic analysis workspaces
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-8 sm:py-12 space-y-4 px-4">
          ...
          <div className="text-center space-y-2 max-w-sm">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              Create your first workspace to start analyzing economic data and
              trends with AI assistance.
            </p>
          </div>{" "}
          <Button
      ...
      <AlertDialog
        ...
        onOpenChange={() => setDeleteWorkspaceId(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              be undone and will permanently delete all messages and data
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() =>
                deleteWorkspaceId && handleDeleteWorkspace(deleteWorkspaceId)
              }
