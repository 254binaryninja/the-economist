...
export default function Vaults() {
    const { vaults, loading, error, editingVault, newVaultName, setNewVaultName, setEditingVault, createVault, fetchVaults, deleteVault, editVault } = useVault();
    ...
    if (error) {
        return (
            <div className="px-4">
                <ErrorState error={error} onRetry={fetchVaults} fullScreen={false} showBackButton={false} />
            </div>
        )
    }

    const handleNavigationToVault = useCallback((id:string)=>{
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        This will permanently delete the vault "{vault.title}". This action cannot be undone.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
                    ...
                    <SidebarMenu>
                        <SidebarMenuItem>
                            <div className="flex flex-col items-center justify-center p-4 text-center">
                                <span className="text-gray-500 dark:text-gray-400 mb-2">No workspaces found</span>
                                <Button
                                    variant="outline"
                                    size="sm"
