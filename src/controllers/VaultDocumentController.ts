...
import type { IVaultDocumentRepository, VaultDocumentInsert, VaultDocumentUpdate } from '../domain/repository/IVaultDocumentRepository';

@injectable()
export class VaultDocumentController {
    constructor(
        @inject(TYPES.IVaultDocumentRepository) private vaultDocumentRepository: IVaultDocumentRepository
    ) {}
