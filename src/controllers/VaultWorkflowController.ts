...
import type { IVaultWorkflowRepository, VaultWorkflowInsert, VaultWorkflowUpdate } from '../domain/repository/IVaultWorkflowRepository';

@injectable()
export class VaultWorkflowController {
    constructor(
        @inject(TYPES.IVaultWorkflowRepository) private vaultWorkflowRepository: IVaultWorkflowRepository
    ) {}
