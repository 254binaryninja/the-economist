...
import type { ITextEmbeddingRepository, DocumentMetadataGenerator } from '../domain/repository/ITextEmbeddingRepository';

@injectable()
export class TextEmbeddingController {
    constructor(
        @inject(TYPES.ITextEmbeddingRepository) private textEmbeddingRepository: ITextEmbeddingRepository
    ) {}
