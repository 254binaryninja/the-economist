...
import type { IRedisContext, ChatMessage } from '../domain/repository/IRedisContextRepository';

@injectable()
export class RedisContextController {
    constructor(
        @inject(TYPES.IRedisContextRepository) private redisContextRepository: IRedisContext
    ) {}
