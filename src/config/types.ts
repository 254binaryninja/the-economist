...
export const TYPES ={
    ...
    IVaultDocumentChunkRepository: Symbol.for("IVaultDocumentChunkRepository"),    IWorkspaceRepository: Symbol.for("IWorkspaceRepository"),
    ...
    VaultDocumentChunkController: Symbol.for("VaultDocumentChunkController"),    WorkspaceController: Symbol.for("WorkspaceController"),
