...
container.bind<IVaultWorkflowRepository>(TYPES.IVaultWorkflowRepository).to(IVaultWorkflowService).inSingletonScope();
container.bind<IVaultDocumentChunkRepository>(TYPES.IVaultDocumentChunkRepository).to(IVaultDocumentChunkService).inSingletonScope();
...
container.bind<VaultWorkflowController>(TYPES.VaultWorkflowController).to(VaultWorkflowController).inSingletonScope();
container.bind<VaultDocumentChunkController>(TYPES.VaultDocumentChunkController).to(VaultDocumentChunkController).inSingletonScope();
