...
export interface IWorkspaceMessagesRepository {
   ...
   insertMessageToWorkspace(workspaceMessage: WorkspaceMessageInsert): Promise<WorkspaceMessage>;
   updateMessageInWorkspace(id: string, workspaceMessage: WorkspaceMessageUpdate): Promise<WorkspaceMessage | null>;
}