        ...
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted flex items-center justify-center p-4">
            <div className="w-full max-w-lg space-y-8">
                ...
                <div className="text-center space-y-3">
                    ...
                    <h1 className="text-3xl font-bold text-foreground">Welcome to The Economist AI</h1>
                                    ...
                                    <FormItem className="space-y-3">
                                        <div className="flex items-start space-x-3 p-4 rounded-lg border border-border/50 bg-muted/30">
                                            ...
                                            <div className="space-y-2 leading-none">
                                                ...
                                                <FormDescription className="text-muted-foreground text-sm">
                                                    Get access to educational resources, student discounts, and academic tools
                                                </FormDescription>
                                            </div>
                                        </div>
                                        <FormMessage />
