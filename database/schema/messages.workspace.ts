...
export const workspaceMessage = p.pgTable('workspace_messages',{
    ...
    workspace_id:p.uuid('workspace_id').notNull().references(()=>workspace.id,{onDelete:'cascade'}),
...
export const workspaceMessageRelations = relations(workspaceMessage,({one})=>({
