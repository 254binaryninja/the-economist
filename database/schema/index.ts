...
import { workspace,workspaceRelations } from "./workspace"
import { workspaceMessage,workspaceMessageRelations } from "./messages.workspace";
import { vault,vaultRelations } from "./vault";
...
export {
    ...
    workspaceRelations,
    workspaceMessage,
    workspaceMessageRelations,
    vault,
    vaultRelations,
    vaultDocuments,
    vaultDocumentsRelations,
    vaultMessages,
