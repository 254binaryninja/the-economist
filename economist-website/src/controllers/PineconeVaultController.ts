...
import type {
  ...
  VectorMetadata,
} from "../domain/repository/IPineconeVaultRepository";

@injectable()
export class PineconeVaultController {
  constructor(
    @inject(TYPES.IPineconeVaultRepository)
    private pineconeVaultRepository: IPineconeVaultRepository,
  ) {}
  ...
  async query(
    ...
    return this.pineconeVaultRepository.query(
      namespace,
      embedding,
      topK,
      filter,
